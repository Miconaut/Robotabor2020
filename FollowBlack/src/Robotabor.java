...
public abstract class Robotabor {
	...
	public enum SENSOR {
		 ...
		 *
		 * Pristup k prvnimu sensoru pres light1, k dalsim s vyssim cislem
		 * (jde o pocet pouzitych stejnych sensoru, ne o zapojeni do portu). </br>
		 * </br>
		 *
	...
	public static void init(SENSOR p1, SENSOR p2, SENSOR p3, SENSOR p4) {
		print("EasyRobotLibrary v 2020.3\n");
		_TT = new Stopwatch();
		_TT.reset();
	...
	public static class Buggy {
		...
		public void speed(float mmps) {
			float stupnu_za_sekundu = (180 / 3.141592653589f) * mmps / _R;
			if (stupnu_za_sekundu > 450)
				stupnu_za_sekundu = 450;
			motR.setSpeed(stupnu_za_sekundu);
			motL.setSpeed(stupnu_za_sekundu);
		}
		...
		public void speed(float left_mmps, float right_mmps) {
			float stupnu_za_sekundu = (180 / 3.141592653589f) * left_mmps / _R;
			if (stupnu_za_sekundu > 450)
				stupnu_za_sekundu = 450;
			motL.setSpeed(stupnu_za_sekundu);
			stupnu_za_sekundu = (180 / 3.141592653589f) * right_mmps / _R;
			if (stupnu_za_sekundu > 450)
				stupnu_za_sekundu = 450;
			motR.setSpeed(stupnu_za_sekundu);
		}
